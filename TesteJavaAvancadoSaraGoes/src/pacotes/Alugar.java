		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					...
					enviarDados.BaseDadosAlugar(data, formattedTextFieldMatricula.getText().trim(),comboBoxCC.getSelectedItem().toString(),textFieldNomeCliente.getText(), serviço, valor);
